...
public class CameraView extends View implements SurfaceHolder.Callback, View.OnTouchListener{
    ...
    private boolean realyStart() {
        ...
        try {
	        ...
	        Log.d("IPCAM", "JAVA:  camera prepare illegal error");
            return false;
	    } catch (IOException e) {
	        releaseMediaRecorder();	    
	        Log.d("IPCAM", "JAVA:  camera prepare io error");
            return false;
	    }
        ...
        try {
            ...
            releaseMediaRecorder();
	        Log.d("IPCAM", "JAVA:  camera start error");
            return false;
        }
    ...
    private MediaRecorder.OnInfoListener streamingEventHandler = new MediaRecorder.OnInfoListener() {
        ...
        public void onInfo(MediaRecorder mr, int what, int extra) {
            Log.d("IPCAM", "MediaRecorder event = " + what);    
        }
    };
